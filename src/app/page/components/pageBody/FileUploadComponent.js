        ...
        return (               
            <div className='filesDiv2'>
                <div className='frm_grp2 prfl_img2'>
                    ...
                    <img className='profile_pic2' id='blah' src={this.state.avatarPath===undefined  || this.state.avatarPath===null  || this.state.avatarPath==='' ? '/images/default.png' : this.state.avatarPath} alt='' />
                </div>
            </div>
        );
    } 
