...
import { ProfileAction } from '../../../../actions/UserAction';
                    ...
                    <form onSubmit={this.props.handleSubmit}>
                       <div className="frm_grp2">
                        ...
                        <div className="frm_grp2">
                            ...
                            <Field disabled="true" component="input" type="email" name="email" value={this.props.user.email}/>
                        </div>
                        <div className="frm_grp2">
                        ...
                        <div className="frm_grp2">
                            <div className="half_fld2">
                                ...
                                <Field component="input" type="password" id="password" className="form-control2" name="password"/>
                            </div>
                            <div className="half_fld2">
                                <label>Confirm Password</label>
                                <Field component="input" type="password" id="password" className="form-control2" name="password2"/>
                            </div>
...
const mapStateToProps = (state, ownProps) => {
    let initialValues = {
        ...
        username : ownProps.user.profile.display_name,
